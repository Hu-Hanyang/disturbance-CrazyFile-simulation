...
# Hanyang: the class DroneHoverFreeEnv is used for no-goal-position hover task
class DroneHoverFreeEnv(DroneBaseEnv):
    def __init__(
            self,
            physics,
            control_mode: str,
        ...
        # Hanyang: add disturbance level as one attribute
        self.disturbance_level = 0.0

        super(DroneHoverFreeEnv, self).__init__(
    ...
    def compute_potential(self) -> float:
        ...
        return np.linalg.norm(self.drone.xyz - self.target_pos)  # Hanyang: TODO: need to verify the function of this method

    def compute_reward(self, action) -> float:  # Hanyang: redesigning
        # Determine penalties
...
class DroneHoverBulletFreeEnvWithAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithAdversary, self)._setup_task_specifics()
...
class DroneHoverBulletFreeEnvWithRandomHJAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithRandomHJAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
            physics='PybulletPhysicsWithAdversary',  # physics env, not the concept in rl
        ...
        self.id = 'DroneHoverBulletFreeEnvWithRandomHJAdversary'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithRandomHJAdversary, self)._setup_task_specifics()
...
class DroneHoverBulletFreeEnvWithoutAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithoutAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
        ...
        self.id = 'DroneHoverBulletFreeEnvWithoutAdversary'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithoutAdversary, self)._setup_task_specifics()
    ...
    def render(self, mode="human"):
        super(DroneHoverBulletFreeEnvWithoutAdversary, self).render(mode)
...
class DroneHoverBulletFreeEnvWithRandomAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithRandomAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
            physics='PybulletPhysicsWithAdversary',
        ...
        self.dstb_space = gym.spaces.Box(low=np.array([-1*10**-3, -1*10**-3, -1*10**-4]), 
                                        ...
                                        dtype=np.float32)
        self.dstb_gen   = lambda x: self.dstb_space.sample() 
        self.id = 'DroneHoverBulletFreeEnvWithRandomAdversary'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithRandomAdversary, self)._setup_task_specifics()
    ...
    """
    def render(self, mode="human"):
        super(DroneHoverBulletFreeEnvWithRandomAdversary, self).render(mode)
...
class DroneHoverBulletFreeEnvWithAdversaryInitial(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithAdversaryInitial, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
            physics='PybulletPhysicsWithAdversary',  # physics env, not the concept in rl
        ...
        self.id = 'DroneHoverBulletFreeEnvWithAdversaryInitial'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithAdversaryInitial, self)._setup_task_specifics()
...
class DroneHoverBulletFreeEnvWithCurriculumHJAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverBulletFreeEnvWithCurriculumHJAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
            physics='PybulletPhysicsWithAdversary',  # physics env, not the concept in rl
        ...
        self.id = 'DroneHoverBulletFreeEnvWithCurriculumHJAdversary'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverBulletFreeEnvWithCurriculumHJAdversary, self)._setup_task_specifics()
...
class DroneHoverFreeBulletEnvWithoutAdversary(DroneHoverFreeEnv):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverFreeBulletEnvWithoutAdversary, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
            drone_model='cf21x_bullet_adversary',  # CrazyFlieBulletAgentWithAdversary
            physics='PybulletPhysicsWithAdversary',
        ...
        # self.dstb_gen   = lambda x: self.dstb_space.sample() 
        self.disturbance_level = 0.0 # Dmax = uMax * disturbance_level
        self.id = 'DroneHoverFreeBulletEnvWithoutAdversary'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverFreeBulletEnvWithoutAdversary, self)._setup_task_specifics()
    ...
    """
    def render(self, mode="human"):
        super(DroneHoverFreeBulletEnvWithoutAdversary, self).render(mode)
