...
class DroneHoverCurriculumEnv(DroneHoverBaseEnv):  #TODO: Not finished yet
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
        super(DroneHoverCurriculumEnv, self).__init__(
            aggregate_phy_steps=aggregate_phy_steps,
            control_mode=control_mode,
        ...
        # self.disturbance_level = 0.0
        self.epoch = 0
        self.disturbance_level = kwargs['distb_level']
        print("In hover_curriculum.py file, the disturbance level is: ", self.disturbance_level)

        self.id = 'DroneHoverCurriculumEnv'
    ...
    """
    def _setup_task_specifics(self):
        super(DroneHoverCurriculumEnv, self)._setup_task_specifics()
